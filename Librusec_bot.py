...
USERS_JSON_FILE = os.getenv('USERS_JSON_FILE', '/app/data/users_librusec.json')
PENDING_USERS_JSON_FILE = os.getenv('PENDING_USERS_JSON_FILE', '/app/data/pending_users_librusec.json')
LOG_FILE = os.getenv('LOG_FILE', '/app/data/Log_librusecBase_bot.log')
DB_FILE = os.getenv('DB_FILE', '/app/data/reader_data_librusec.db') # Явный путь для персистентности
